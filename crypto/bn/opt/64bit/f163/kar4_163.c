...
void kar4_163_64(uint64_t Out0[6], const uint64_t In0[3], const uint64_t In1[3])
{
	uint64_t Var0[2];
	uint64_t Var1[3];
	uint64_t Var2[2];
	...
	Var5[0] = In1[0];
	Var5[1] = In1[1];
	combx4_163_64(Var6, Var0, Var3);
	combx4_163_64(Var7, Var2, Var5);
	Var9[0] = Var3[0] ^ Var5[0];
	Var9[1] = Var3[1] ^ Var5[1];
	Var10[0] = Var0[0] ^ Var2[0];
	Var10[1] = Var0[1] ^ Var2[1];
	combx4_163_64(Var8, Var10, Var9);
	Var11[0] = 0u;
	Var11[1] = 0u;
	Var11[2] = 0u;
	Var11[3] = 0u;
