...
void kar5_409_64(uint64_t Out0[13], const uint64_t In0[7], const uint64_t In1[7])
{
	uint64_t Var0[4];
	uint64_t Var1[7];
	uint64_t Var2[4];
	...
	Var5[2] = In1[2];
	Var5[3] = In1[3];
	combx5_409_64(Var6, Var0, Var3);
	combx5_409_64(Var7, Var2, Var5);
