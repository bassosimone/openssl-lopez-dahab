...
void kar5_571_64(uint64_t Out0[18], const uint64_t In0[9], const uint64_t In1[9])
{
	uint64_t Var0[5];
	uint64_t Var1[9];
	uint64_t Var2[5];
	...
	Var5[3] = In1[3];
	Var5[4] = In1[4];
	combx5_571_64(Var6, Var0, Var3);
	combx5_571_64(Var7, Var2, Var5);
