...
void inv_571_64(uint64_t Out0[9], const uint64_t In0[9])
{
	uint64_t Var0[9];
	uint64_t Var1[9] = { 0x425u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0x800000000000000u };
	uint64_t Var2[9] = { 0x1u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u };
	uint64_t Var3[9] = { 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u };
	unsigned int Var4;
	unsigned int Var5;
	int Var6;
	int Var7;
	...
	Var0[6] = In0[6];
	Var0[7] = In0[7];
	Var0[8] = (In0[8] & 0x7ffffffffffffffu) ^ (Var0[8] & 0xf800000000000000u);
	Var5 = (Var0[0] != 0x1u) || (Var0[1] != 0u) || (Var0[2] != 0u) || (Var0[3] != 0u) || (Var0[4] != 0u) || (Var0[5] != 0u) || (Var0[6] != 0u) || (Var0[7] != 0u) || ((Var0[8] & 0xfffffffffffffffu) != 0u);
	Var4 = Var5;
	while (Var4 != 0u)
	{
	msb_571_64(&Var6, Var0);
	msb_571_64(&Var7, Var1);
	Var9 = Var6 - Var7;
	Var8 = Var9;
	Var10 = Var8 < 0;
	if (Var10 != 0u)
		...
		else
		{
			if (Var8 % 64u == 0u)
			{
				if (8u < Var8 / 64u)
					...
					Var13[8] = Var1[8u - (Var8 / 64u)];
				if (7u < Var8 / 64u)
					Var13[7] = 0u;
				else
					Var13[7] = Var1[7u - (Var8 / 64u)];
				if (6u < Var8 / 64u)
					Var13[6] = 0u;
				else
			...
			else
			{
				if (8u < Var8 / 64u)
					...
					Var13[8] = Var1[0] << Var8 % 64u;
				else
					Var13[8] = (Var1[8 - Var8 / 64u] << Var8 % 64u) ^ (Var1[8 - Var8 / 64u - 1u] >> (64u - Var8 % 64u));
				if (7u < Var8 / 64u)
					Var13[7] = 0u;
				else if (7u == Var8 / 64u)
					Var13[7] = Var1[0] << Var8 % 64u;
				else
					Var13[7] = (Var1[7 - Var8 / 64u] << Var8 % 64u) ^ (Var1[7 - Var8 / 64u - 1u] >> (64u - Var8 % 64u));
				if (6u < Var8 / 64u)
					Var13[6] = 0u;
				else if (6u == Var8 / 64u)
		...
		else
		{
			if (Var8 % 64u == 0u)
			{
				if (8u < Var8 / 64u)
					...
					Var15[8] = Var3[8u - (Var8 / 64u)];
				if (7u < Var8 / 64u)
					Var15[7] = 0u;
				else
					Var15[7] = Var3[7u - (Var8 / 64u)];
				if (6u < Var8 / 64u)
					Var15[6] = 0u;
				else
			...
			else
			{
				if (8u < Var8 / 64u)
					...
					Var15[8] = Var3[0] << Var8 % 64u;
				else
					Var15[8] = (Var3[8 - Var8 / 64u] << Var8 % 64u) ^ (Var3[8 - Var8 / 64u - 1u] >> (64u - Var8 % 64u));
				if (7u < Var8 / 64u)
					Var15[7] = 0u;
				else if (7u == Var8 / 64u)
					Var15[7] = Var3[0] << Var8 % 64u;
				else
					Var15[7] = (Var3[7 - Var8 / 64u] << Var8 % 64u) ^ (Var3[7 - Var8 / 64u - 1u] >> (64u - Var8 % 64u));
				if (6u < Var8 / 64u)
					Var15[6] = 0u;
				else if (6u == Var8 / 64u)
	...
	Var2[7] = Var16[7];
	Var2[8] = Var16[8];
	Var17 = (Var0[0] != 0x1u) || (Var0[1] != 0u) || (Var0[2] != 0u) || (Var0[3] != 0u) || (Var0[4] != 0u) || (Var0[5] != 0u) || (Var0[6] != 0u) || (Var0[7] != 0u) || ((Var0[8] & 0xfffffffffffffffu) != 0u);
	Var4 = Var17;
	}
	Out0[0] = Var2[0];
	Out0[1] = Var2[1];
