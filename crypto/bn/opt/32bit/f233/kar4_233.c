#include <stdint.h>
#include "combx4_233.h"


void kar4_233_32(uint32_t Out0[15], const uint32_t In0[8], const uint32_t In1[8])
{
	uint32_t Var0[4];
	uint32_t Var1[8];
	uint32_t Var2[4];
	...
	Var5[2] = In1[2];
	Var5[3] = In1[3];
	combx4_233_32(Var6, Var0, Var3);
	combx4_233_32(Var7, Var2, Var5);
