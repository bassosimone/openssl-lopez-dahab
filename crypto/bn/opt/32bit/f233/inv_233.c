...
void inv_233_32(uint32_t Out0[8], const uint32_t In0[8])
{
	uint32_t Var0[8];
	uint32_t Var1[8] = { 0x1u, 0u, 0x400u, 0u, 0u, 0u, 0u, 0x200u };
	uint32_t Var2[8] = { 0x1u, 0u, 0u, 0u, 0u, 0u, 0u, 0u };
	uint32_t Var3[8] = { 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u };
	unsigned int Var4;
	unsigned int Var5;
	int Var6;
	int Var7;
	...
	Var0[5] = In0[5];
	Var0[6] = In0[6];
	Var0[7] = (In0[7] & 0x1ffu) ^ (Var0[7] & 0xfffffe00u);
	Var5 = (Var0[0] != 0x1u) || (Var0[1] != 0u) || (Var0[2] != 0u) || (Var0[3] != 0u) || (Var0[4] != 0u) || (Var0[5] != 0u) || (Var0[6] != 0u) || ((Var0[7] & 0x3ffu) != 0u);
	Var4 = Var5;
	while (Var4 != 0u)
	{
	msb_233_32(&Var6, Var0);
	msb_233_32(&Var7, Var1);
	Var9 = Var6 - Var7;
	Var8 = Var9;
	Var10 = Var8 < 0;
	if (Var10 != 0u)
	...
	Var2[6] = Var16[6];
	Var2[7] = Var16[7];
	Var17 = (Var0[0] != 0x1u) || (Var0[1] != 0u) || (Var0[2] != 0u) || (Var0[3] != 0u) || (Var0[4] != 0u) || (Var0[5] != 0u) || (Var0[6] != 0u) || ((Var0[7] & 0x3ffu) != 0u);
	Var4 = Var17;
	}
	Out0[0] = Var2[0];
	Out0[1] = Var2[1];
