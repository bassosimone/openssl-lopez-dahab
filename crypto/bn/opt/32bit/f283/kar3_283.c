#include <stdint.h>
#include "combx3_283.h"


void kar3_283_32(uint32_t Out0[18], const uint32_t In0[9], const uint32_t In1[9])
{
	uint32_t Var0[5];
	uint32_t Var1[9];
	uint32_t Var2[5];
	...
	Var5[3] = In1[3];
	Var5[4] = In1[4];
	combx3_283_32(Var6, Var0, Var3);
	combx3_283_32(Var7, Var2, Var5);
