...
void inv_571_32(uint32_t Out0[18], const uint32_t In0[18])
{
	uint32_t Var0[18];
	uint32_t Var1[18] = { 0x425u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0x8000000u };
	uint32_t Var2[18] = { 0x1u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u };
	uint32_t Var3[18] = { 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u };
	unsigned int Var4;
	unsigned int Var5;
	int Var6;
	int Var7;
	...
	Var0[15] = In0[15];
	Var0[16] = In0[16];
	Var0[17] = (In0[17] & 0x7ffffffu) ^ (Var0[17] & 0xf8000000u);
	Var5 = (Var0[0] != 0x1u) || (Var0[1] != 0u) || (Var0[2] != 0u) || (Var0[3] != 0u) || (Var0[4] != 0u) || (Var0[5] != 0u) || (Var0[6] != 0u) || (Var0[7] != 0u) || (Var0[8] != 0u) || (Var0[9] != 0u) || (Var0[10] != 0u) || (Var0[11] != 0u) || (Var0[12] != 0u) || (Var0[13] != 0u) || (Var0[14] != 0u) || (Var0[15] != 0u) || (Var0[16] != 0u) || ((Var0[17] & 0xfffffffu) != 0u);
	Var4 = Var5;
	while (Var4 != 0u)
	{
	msb_571_32(&Var6, Var0);
	msb_571_32(&Var7, Var1);
	Var9 = Var6 - Var7;
	Var8 = Var9;
	Var10 = Var8 < 0;
	if (Var10 != 0u)
		...
		else
		{
			if (Var8 % 32u == 0u)
			{
				if (17u < Var8 / 32u)
					...
					Var13[17] = Var1[17u - (Var8 / 32u)];
				if (16u < Var8 / 32u)
					Var13[16] = 0u;
				else
					Var13[16] = Var1[16u - (Var8 / 32u)];
				if (15u < Var8 / 32u)
					Var13[15] = 0u;
				else
					Var13[15] = Var1[15u - (Var8 / 32u)];
				if (14u < Var8 / 32u)
					Var13[14] = 0u;
				else
					Var13[14] = Var1[14u - (Var8 / 32u)];
				if (13u < Var8 / 32u)
					Var13[13] = 0u;
				else
					Var13[13] = Var1[13u - (Var8 / 32u)];
				if (12u < Var8 / 32u)
					Var13[12] = 0u;
				else
			...
			else
			{
				if (17u < Var8 / 32u)
					Var13[17] = 0u;
				else if (17u == Var8 / 32u)
					Var13[17] = Var1[0] << Var8 % 32u;
				else
					Var13[17] = (Var1[17 - Var8 / 32u] << Var8 % 32u) ^ (Var1[17 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (16u < Var8 / 32u)
					Var13[16] = 0u;
				else if (16u == Var8 / 32u)
					Var13[16] = Var1[0] << Var8 % 32u;
				else
					Var13[16] = (Var1[16 - Var8 / 32u] << Var8 % 32u) ^ (Var1[16 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (15u < Var8 / 32u)
					Var13[15] = 0u;
				else if (15u == Var8 / 32u)
					Var13[15] = Var1[0] << Var8 % 32u;
				else
					Var13[15] = (Var1[15 - Var8 / 32u] << Var8 % 32u) ^ (Var1[15 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (14u < Var8 / 32u)
					Var13[14] = 0u;
				else if (14u == Var8 / 32u)
					Var13[14] = Var1[0] << Var8 % 32u;
				else
					Var13[14] = (Var1[14 - Var8 / 32u] << Var8 % 32u) ^ (Var1[14 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (13u < Var8 / 32u)
					Var13[13] = 0u;
				else if (13u == Var8 / 32u)
					Var13[13] = Var1[0] << Var8 % 32u;
				else
					Var13[13] = (Var1[13 - Var8 / 32u] << Var8 % 32u) ^ (Var1[13 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (12u < Var8 / 32u)
					Var13[12] = 0u;
	...
	Var14[13] = Var0[13] ^ Var13[13];
	Var14[14] = Var0[14] ^ Var13[14];
	Var14[15] = Var0[15] ^ Var13[15];
	Var14[16] = Var0[16] ^ Var13[16];
	Var14[17] = Var0[17] ^ Var13[17];
	Var0[0] = Var14[0];
	Var0[1] = Var14[1];
	Var0[2] = Var14[2];
	Var0[3] = Var14[3];
		...
		else
		{
			if (Var8 % 32u == 0u)
			{
				if (17u < Var8 / 32u)
					...
					Var15[17] = Var3[17u - (Var8 / 32u)];
				if (16u < Var8 / 32u)
					Var15[16] = 0u;
				else
					Var15[16] = Var3[16u - (Var8 / 32u)];
				if (15u < Var8 / 32u)
					Var15[15] = 0u;
				else
					Var15[15] = Var3[15u - (Var8 / 32u)];
				if (14u < Var8 / 32u)
					Var15[14] = 0u;
				else
					Var15[14] = Var3[14u - (Var8 / 32u)];
				if (13u < Var8 / 32u)
					Var15[13] = 0u;
				else
					Var15[13] = Var3[13u - (Var8 / 32u)];
				if (12u < Var8 / 32u)
					Var15[12] = 0u;
				else
			...
			else
			{
				if (17u < Var8 / 32u)
					...
					Var15[17] = Var3[0] << Var8 % 32u;
				else
					Var15[17] = (Var3[17 - Var8 / 32u] << Var8 % 32u) ^ (Var3[17 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (16u < Var8 / 32u)
					Var15[16] = 0u;
				else if (16u == Var8 / 32u)
					Var15[16] = Var3[0] << Var8 % 32u;
				else
					Var15[16] = (Var3[16 - Var8 / 32u] << Var8 % 32u) ^ (Var3[16 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (15u < Var8 / 32u)
					Var15[15] = 0u;
				else if (15u == Var8 / 32u)
					Var15[15] = Var3[0] << Var8 % 32u;
				else
					Var15[15] = (Var3[15 - Var8 / 32u] << Var8 % 32u) ^ (Var3[15 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (14u < Var8 / 32u)
					Var15[14] = 0u;
				else if (14u == Var8 / 32u)
					Var15[14] = Var3[0] << Var8 % 32u;
				else
					Var15[14] = (Var3[14 - Var8 / 32u] << Var8 % 32u) ^ (Var3[14 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (13u < Var8 / 32u)
					Var15[13] = 0u;
				else if (13u == Var8 / 32u)
					Var15[13] = Var3[0] << Var8 % 32u;
				else
					Var15[13] = (Var3[13 - Var8 / 32u] << Var8 % 32u) ^ (Var3[13 - Var8 / 32u - 1u] >> (32u - Var8 % 32u));
				if (12u < Var8 / 32u)
					Var15[12] = 0u;
				else if (12u == Var8 / 32u)
	...
	Var16[13] = Var2[13] ^ Var15[13];
	Var16[14] = Var2[14] ^ Var15[14];
	Var16[15] = Var2[15] ^ Var15[15];
	Var16[16] = Var2[16] ^ Var15[16];
	Var16[17] = Var2[17] ^ Var15[17];
	Var2[0] = Var16[0];
	Var2[1] = Var16[1];
	Var2[2] = Var16[2];
	Var2[3] = Var16[3];
	...
	Var2[16] = Var16[16];
	Var2[17] = Var16[17];
	Var17 = (Var0[0] != 0x1u) || (Var0[1] != 0u) || (Var0[2] != 0u) || (Var0[3] != 0u) || (Var0[4] != 0u) || (Var0[5] != 0u) || (Var0[6] != 0u) || (Var0[7] != 0u) || (Var0[8] != 0u) || (Var0[9] != 0u) || (Var0[10] != 0u) || (Var0[11] != 0u) || (Var0[12] != 0u) || (Var0[13] != 0u) || (Var0[14] != 0u) || (Var0[15] != 0u) || (Var0[16] != 0u) || ((Var0[17] & 0xfffffffu) != 0u);
	Var4 = Var17;
	}
	Out0[0] = Var2[0];
	Out0[1] = Var2[1];
