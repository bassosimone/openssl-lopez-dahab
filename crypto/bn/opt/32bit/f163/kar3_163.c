...
void kar3_163_32(uint32_t Out0[11], const uint32_t In0[6], const uint32_t In1[6])
{
	uint32_t Var0[3];
	uint32_t Var1[6];
	uint32_t Var2[3];
	...
	Var5[1] = In1[1];
	Var5[2] = In1[2];
	combx3_163_32(Var6, Var0, Var3);
	combx3_163_32(Var7, Var2, Var5);
